...
public class GasTank extends CarPart {
	...
	public void fillTank(float numOfGallons) {
		...
		if (this.condition < 0) {
			this.status("Huun Nice try, Impossible to seal my gas with a negative number! Adding "
					+ remainder + " maximum capacity in gallons.");
			...
			this.status("Adding " + numOfGallons + " gallons. Now you have "
